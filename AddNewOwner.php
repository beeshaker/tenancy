...
if($_SERVER['REQUEST_METHOD']==='POST')
{
	...
	$cert = ($_POST['cert']);
	$pin = ($_POST['pin']);
	$sql = "INSERT INTO owner(Fname,PostAdd,Pin,Id,Cert,Mobile,Email) VALUES('$fname','$pa','$pin','$id','$cert','$phone','$email')";
	if($conn->query($sql) === true)
	{
		echo '<script>alert("The Owner has been added.")</script>';
...
<body>
	...
	<div style="padding-top: 5%; padding-bottom: 2%; padding-right: 10%; padding-left: 40%">
		...
		<div class="row">
		    <div class="col-md-6">
		      <form action="AddNewOwner.php" method="POST" enctype="multipart/form-data">
		    ...
		    <div class="col-md-6">
		   		<div class="form-group">
				    ...
				    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Postal address" name="pa">
				</div>
		    </div>	
		    <div class="col-md-6">
		   		<div class="form-group">
		    ...
		    <div class="col-md-4">
		   		<div class="form-group">
				    ...
				    <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="ID Number" name="idnum">
				</div>
		    </div>	
		    <div class="col-md-4">
		   		<div class="form-group">
