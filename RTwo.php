...
<body>
	...
	<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
		...
		<table class="table">
		  	...
		  	<?php
				$sql = "SELECT lease.Lease_Id,property.Name,tenant.Fname From property inner join lease on property.Property_Id = lease.PropertyId inner join tenant on lease.TenantId = tenant.Tenant_Id where TIMESTAMPDIFF(day,CURDATE(),EndDate) Between 32 and 61 and Lstatus = 'Ongoing'";
		...
		<a href="RthreeExport.php"><button type="button" class="btn btn-primary">Download Report</button></a>
	</div>
</div>
</body>
</html>			
