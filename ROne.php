...
<body>
	...
	<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
		...
		<table class="table">
		  	...
		  	<?php
				...
				inner join tenant on lease.TenantId = tenant.Tenant_Id
    				where TIMESTAMPDIFF(day,CURDATE(),EndDate) Between 1 and 31 and Lstatus = 'Ongoing'";
		...
		<a href="emailsend.php"><button type="button" class="btn btn-primary">Send mail</button></a>
	</div>
</div>
</body>
</html>			
