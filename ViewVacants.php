	...
	<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
						    <form action="ViewVacants.php" method="POST">
		...
		<table class="table">
		  	...
		  	if($_SERVER['REQUEST_METHOD']==='POST')
			{
				...
				$sql = "SELECT DISTINCT Unit FROM `lease` WHERE `PropertyId` = $pid and Unit NOT in (SELECT DISTINCT Unit FROM lease where Lstatus = 'Ongoing' and PropertyId = $pid)";
