	...
	<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
		...
		<div class="col-md-2" style="background-color: #FFFFFF">
			<ul style="padding-top: 1%; padding-bottom: 1%; padding-right: 0%; padding-left: 0%;list-style-type: none;">
      			...
      			<li style="padding-top: 2%; padding-bottom: 2%;">
      				<button type="button" class="btn btn-dark btn-block"><a href="Dashboard.php" style="color:white;">Back</a></button>
      			</li>
      		</ul>
		</div>
		...
		<table class="table">
		  	...
		  	<?php
				$sql = "SELECT lease.Lease_Id,property.Name,tenant.Fname From property inner join lease on property.Property_Id = lease.PropertyId inner join tenant on lease.TenantId = tenant.Tenant_Id where lease.signed = 0 ";
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="UpdateLease.php?action=view&l_id=<?php echo $row['Lease_Id']?>" style="color:white;">Update</a></button></td>
		...
		<a href="unsignedExport.php"><button type="button" class="btn btn-primary">Download Report</button></a>
	</div>
</div>
</body>
</html>			
