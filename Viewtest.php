	...
	<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
		...
		<table class="table">
		  	...
		  	if($_SERVER['REQUEST_METHOD']==='POST')
			{
				...
				$sql = "SELECT * FROM property INNER JOIN lease ON lease.PropertyId = property.Property_Id INNER JOIN tenant on lease.TenantId = tenant.Tenant_Id WHERE PropertyId = $pid";
		  ...
		  <tbody>
		    <tr>
		      ...
		      <td><button type="button" name = "view"class="btn btn-dark"><a href="ViewLease.php?action=view&l_id=<?php echo $row['Lease_Id']?>" style="color:white;">VIEW</a></button></td>
		    </tr>
		    		<?php
