...
<body>
	...
	<div style="padding-top: 3%; padding-bottom: 2%; padding-right: 5%; padding-left: 5%">
		...
		<table class="table">
		  	...
		  	<?php
				$sql = "SELECT lease.Lease_Id,property.Name,tenant.Fname From property inner join lease on property.Property_Id = lease.PropertyId inner join tenant on lease.TenantId = tenant.Tenant_Id where TIMESTAMPDIFF(day,CURDATE(),IncDate) Between 62 and 91 and Lstatus = 'Ongoing'";
